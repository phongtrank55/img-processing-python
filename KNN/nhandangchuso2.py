...
testImg = cv2.imread('../Image/number3.PNG',0)
cv2.imshow('Anh kiem tra', testImg)
imgTest = np.array(cv2.resize(testImg, (20, 20))).reshape(-1, 20*20).astype(np.float32)
# imgTest = np.array(testImg).reshape(-1, 20*20).
